...
public class ModItems {
    ...
    public static ToolItem URANIUM_SWORD = new SwordItem(UraniumToolMaterial.INSTANCE, 0, -2.4F, new Item.Settings().group(ItemGroup.COMBAT));
    public static ToolItem URANIUM_SHOVEL = new ShovelItem(UraniumToolMaterial.INSTANCE, 1.5F, -3.0F, new Item.Settings().group(ItemGroup.TOOLS));
    //Block Items
    ...
    public static class UraniumPickaxeItem extends PickaxeItem {
        ...
        public static ToolItem URANIUM_PICKAXE = new UraniumPickaxeItem(UraniumToolMaterial.INSTANCE, -2, -2.8F, new Item.Settings().group(ItemGroup.TOOLS));
    }
    ...
    public static class UraniumAxeItem extends AxeItem {
        ...
        public static ToolItem URANIUM_AXE = new UraniumAxeItem(UraniumToolMaterial.INSTANCE, 2, -3.1F, new Item.Settings().group(ItemGroup.TOOLS));
    }
    ...
    public static class UraniumHoeItem extends HoeItem {
        ...
        public static ToolItem URANIUM_HOE = new UraniumHoeItem(UraniumToolMaterial.INSTANCE, -6, 0F, new Item.Settings().group(ItemGroup.TOOLS));
    }
}